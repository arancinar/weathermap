...
function calcRoute() {
  ...
  var pastlong = 62.45562052844832;
  var pastlat = -114.3736336308059;
     ...
     let f = directionsService.route(request, function (result, status){
      ...
      f.then(()=> {
        ...
        for (var i = 0; i <totallength; i++){
          if(i%10 == 0){
            result2.routes[0].overview_path;
            console.log(result2.routes[0].overview_path[i].lng());
        ...
        //console.log(result2.routes[0].overview_path[i].lat());
        })
